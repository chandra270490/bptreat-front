                ...
                <div className="active tab-pane" id="settings">
                    <form className="form-horizontal">
                      <div className="form-group">
                        ...
                        {/* <span>{name}</span> */}
                          <input type="text"  className="form-control" id="inputName" placeholder="" name="fname" value={name} onChange={(e)=>setname(e.target.value)} readOnly/>
                       ...
                       <div className="form-group">
                        ...
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="inputName" placeholder="" name="fname" value={password} onChange={(e)=>setpassword(e.target.value)} readOnly/>
                          {errors.fname && <span className='validationError'>Required</span>}
                        </div> 
                      </div>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10">
                        <input type="text"  className="form-control" id="inputName" placeholder="" value={state} name="fname" onChange={(e)=>setstate(e.target.value)} readOnly/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10"> 
                        <input type="text"  className="form-control" id="inputName" placeholder="" value={mobile} name="fname" onChange={(e)=>setmobile(e.target.value)} readOnly/>
                        </div> 
                      </div> 
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10"> 
                        <input type="text"  className="form-control" id="inputName" placeholder="" value={email} name="fname" onChange={(e)=>setemail(e.target.value)} readOnly/>
                        </div> 
                      </div>
                      <div className="form-group">
                        <label htmlFor="inputName" className="col-sm-2 control-label">Age</label>
                        <div className="col-sm-10"> 
                        <input type="text"  className="form-control" id="inputName" placeholder="" value={age} name="fname" onChange={(e)=>setage(e.target.value)} readOnly/>
                        </div> 
                      </div>
                      <div className="form-group">
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10"> 
                        <input type="text"  className="form-control" id="inputName" placeholder="" value={height} name="fname" onChange={(e)=>setheight(e.target.value)} readOnly/>
                        </div> 
                      </div>
                      <div className="form-group">
                        <label htmlFor="inputName" className="col-sm-2 control-label">Weight</label>
                        <div className="col-sm-10"> 
                        <input type="text"  className="form-control" id="inputName" placeholder="" value={weight} name="fname" onChange={(e)=>setweight(e.target.value)} readOnly/>
                        </div> 
                      </div>
                      <div className="form-group">
                        <label htmlFor="zipcode" className="col-sm-2 control-label">Zipcode</label>
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="zipcode" placeholder="" value={zipcode} name="zipcode" onChange={(e)=>setzipcode(e.target.value)} readOnly/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="hematocrit" placeholder="" value={hematocrit} name="hematocrit" onChange={(e)=>sethematocrit(e.target.value)} readOnly/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="creatinine" placeholder="" value={creatinine} name="creatinine" onChange={(e)=>setcreatinine(e.target.value)} readOnly/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="calcium" placeholder="" value={calcium} name="calcium" onChange={(e)=>setcalcium(e.target.value)} readOnly/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="albumin" placeholder="" value={albumin} name="albumin" onChange={(e)=>setalbumin(e.target.value)} readOnly/>
                      ...
                      <div className="form-group">
                        ...
                        <div className="col-sm-10">
                          <input type="text"  className="form-control" id="tsh" placeholder="" value={tsh} name="tsh" onChange={(e)=>settsh(e.target.value)} readOnly/>
